...
export function WpmChart({ history, wpm, accuracy }: WpmChartProps) {
  ...
  return (
    <div className="relative w-full rounded-2xl border-2 border-[var(--panel-border)] bg-[var(--panel-bg)] p-5 sm:p-6 pb-6 shadow-sm doodle-font">
      <div className="flex items-center justify-between mb-4 px-1 text-xs font-bold">
      ...
      <div className="flex justify-between items-center mt-4 px-1 pb-1 text-[11px] font-bold text-[var(--muted-ink)]">
        <span>0s (Start)</span>
